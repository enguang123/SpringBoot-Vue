    ...
    <el-container>
      <el-aside class="home_aside" width="200px">
        <el-menu router>
          <el-submenu index="1">
            <template slot="title"
              ><i class="el-icon-s-platform"></i>宿管模块</template
            >
            <el-menu-item
          ...
          <el-submenu index="2">
            <template slot="title"
              ><i class="el-icon-user-solid"></i>学生模块</template
            >
            <el-menu-item
              index="/studentAdd"
          ...
          <el-submenu index="3">
            <template slot="title"
              ><i class="el-icon-s-grid"></i>楼宇模块</template
            >
          ...
          <el-submenu index="4">
            <template slot="title"
              ><i class="el-icon-s-home"></i>宿舍模块</template
            >
